...
\-> Ta sẽ có được đường link (http://localhost:8000) — đang chạy sẵn
...
/actions → 4 nút Check in/Check out/DND/Make up room (ẩn hiện theo role). Nhập Room Number = 201 (hoặc số khác trong bảng trên).
